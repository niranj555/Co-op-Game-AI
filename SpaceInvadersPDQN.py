from ple.games.SpaceInvadersPGame import SpaceInvadersGame
from ple import PLE
import numpy as np
import pygame
import sys
...
ACTIONS             = 3 # number of possible actions (go left or right or shoot)
ACTIONS_AI          = 3
    ...
    while True:
        ...
        if MODE == 'train':
            if random.random() <= epsilon:
                ...
                action_index_assistant = random.randrange(ACTIONS)
        ...
        r_t = p.act(actions[np.argmax(a_t_ai)])
